  ...
  const setEp = () => {
    ...
    const renderCards = () => {
      return OtherAnime.slice(startIndex, endIndex).map((item, index) => {
        ...
        return (
          <Link key={item.id} onClick={()=>fetchdata()} to={"/Anime/" + item.id}>
            <Card
              key={index}
              style={{
                margin: 20,
        ...
        <Row style={{ width: "100%" }}>
          ...
          <Col style={{ width: "80%" }}>
            ...
            >
                ...
                {console.log(Add)}
                <img src={Add.pic} type="audio/mp3"  alt={Add.id} />
                
              
            </div>
            <div style={{zIndex:200,position:"absolute",bottom:10,padding:70,textAlign:"justify",background:"rgba(0,0,0,.7)",color:"White",width:"50%",height:"fit-content",margin:"30px "}}>
                  {Add.Description}
                </div>
          </Col>
          {/* Anime Details Block */}
            ...
            >
              ...
              <Row gutter={24}>
                <Col span={5} style={{ textAlign: "center" }}>
                  <img src={Anime.pic} style={{ width: "100%" }} alt={Anime.title} />
                </Col>
                <Col span={19} style={{ textAlign: "left" }}>
                  ...
                  <div>
                    ...
                    {(Anime?.Episodes?.length > 0) ? (<><div key={setEpisodeData} style={{ margin: 10 }}>
                      Episode
